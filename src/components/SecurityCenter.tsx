...
export function SecurityCenter() {
  ...
  return <main className={styles.page}><header><Link href="/"><ArrowLeft size={17} />返回银行</Link><div><span>B</span><b>安全中心</b></div></header><section className={styles.card}>
    <div className={styles.icon}><ShieldCheck size={25} /></div><p>STRONG AUTHENTICATION</p><h1>动态验证器</h1><span>红色操作使用标准 TOTP 一次性动态码。密钥经 AES-256-GCM 加密保存，不进入 Agent 上下文。</span>
